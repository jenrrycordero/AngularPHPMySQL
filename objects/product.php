...
class Product{
    ...
    function readAll(){
        ...
        return $stmt;
    }/*- END readAll() function-*/

    // used when filling up the update product form
    function readOne(){
        
        // query to read single record
        // the symbol ? here will be sumbstituted by the id with the param 1 in the bindParam function
